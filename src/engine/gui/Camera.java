...
public class Camera {
    ...
    public void drawPoint(Graphics g, Coordinate c){
        //System.out.println("Vertex " + (v.getID() - Long.MIN_VALUE) + ":");
        drawCoordinate(g,c);
    }
    
    public void drawLine(Graphics g, Coordinate a, Coordinate b){
        
        int[] start = getPlanarCoordinate(a);
        int[] finish = getPlanarCoordinate(b);
